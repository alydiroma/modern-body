...
var loadPodcasts = function loadPodcasts() {
  var loadedCount = 7; // page loads with 7 podcasts - latest and six more
  document.getElementById('load-more-btn').addEventListener('click', function () {
    var btn = this;
    var offset = parseInt(btn.getAttribute('data-offset'));
    var limit = 6;
    var totalCount = btn.getAttribute('data-count');
...
var customAudio = function customAudio() {
